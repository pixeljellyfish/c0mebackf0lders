...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.titleLabel.text = @"c0meabckf0lders";
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/cbfprefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/cbfprefs.bundle/Banner.png"];
